...
- Why did issue #36 drop the fixed section structure and movie-quote epigraphs that had been stable from #6 through #25? The "💠 Previously on Dimension" box itself only started appearing from issue #21 (issues #6, #7, #11, and #12 have no Dimension box at all) — and #36 does not drop that box, it retains a "🚀 Previously on Dimension" section with the same framing blurb, just emptied of the dated article list. The batch shows the format change happening but never states a reason.
- What became of "Dimension," the sister newsletter cross-promoted in issues #21–#25? Issue #36 still carries a "🚀 Previously on Dimension" section (with the same "sub-newsletter" blurb as earlier issues) but drops the dated list of "3 latest articles" — none of these posts say whether Dimension kept publishing on its own schedule, was folded fully into GroupBy, or was quietly discontinued while the section header lingered.
