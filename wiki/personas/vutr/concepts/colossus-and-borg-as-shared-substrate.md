...
Two of the systems covered in these posts — [[procella|Procella]] at YouTube and BigQuery's Dremel engine — sit on the same pair of Google-internal foundations: Colossus for storage and Borg for compute. Neither post treats this as a coincidence worth dwelling on, but naming the same two systems underneath two very differently-branded products is itself informative about how much of "Google infrastructure" is actually one shared substrate wearing different product names on top.
