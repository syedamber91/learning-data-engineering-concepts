...
- [[B-Trees]] — the book's full mechanism (fixed-size pages, branching factor, splits, WAL, latches, copy-on-write variants) behind the in-place, random-I/O trade-off this entity note summarizes.
